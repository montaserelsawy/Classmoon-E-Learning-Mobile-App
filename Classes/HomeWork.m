...
-(void) getDataJSON{
	...
	NSString * JSONurl =[NSString stringWithFormat:@"%@?user_id=%@&module=homework&limit=%@",API_URL_LINK,[self getUserId],[self getAPIValue]];
	//connect to JSON
	NSArray *JSONArray = [self JSONConnect:JSONurl];
	//GET fields
	homework= [self JSONArray:JSONArray JSONField:@"assignment_title"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
	...
	topLabel.text = [homework objectAtIndex:indexPath.row];
...
#else
	cell.text = [homework objectAtIndex:indexPath.row];
#endif
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	HomeWordDetails * details = [[HomeWordDetails alloc] init];
	details.title = [homework objectAtIndex:indexPath.row];
	//details.cellID = [assignID objectAtIndex:indexPath.row];
